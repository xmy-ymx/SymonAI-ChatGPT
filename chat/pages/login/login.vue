<template>
	<view class="login-content">
		<view class="login-title" v-if="type==2">
			登录
		</view>
		<view class="login-title" v-else-if="type==1">
			注册
		</view>
		<view class="iphone">
		...
		<view class="test-btn" v-if="type==2" @click="setLoginType(1)">手机号注册>></view>
		<view class="password-btn" v-if="type==1" @click="setLoginType(2)">密码登录>></view>
		<view class="login-btn" @click="Login(2)" v-if="type==2">登录</view>
		<view class="login-btn" @click="Login(1)" v-if="type==1">注册</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			Login(e) {
				...
				if(e==2){
					uni.request({
						url: 'http://127.0.0.1:3007/api/login', // 路径
						method: 'POST', // 请求方法,
						header: {
					...
					uni.request({
						url: 'http://127.0.0.1:3007/api/register', // 路径
						method: 'POST', // 请求方法,
						header: {
							'content-type': 'application/x-www-form-urlencoded'
						},
